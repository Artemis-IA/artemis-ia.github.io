...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const model = yield AutoModelForCausalLM.from_pretrained('Xenova/gemini-nano', {
            ...
            const tokenizer = yield AutoTokenizer.from_pretrained('Xenova/gemini-nano');
            ...
            const app = new ChatInterface(predict, {
