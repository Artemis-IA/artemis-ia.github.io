...
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    // ... (Code d'assistance pour les générateurs asynchrones)
};
Object.defineProperty(exports, "__esModule", { value: true });
const transformers_1 = require("@xenova/transformers");
const gradio_1 = require("gradio");
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const model = yield transformers_1.AutoModelForCausalLM.from_pretrained('Xenova/gemini-nano', {
            ...
            const tokenizer = yield transformers_1.AutoTokenizer.from_pretrained('Xenova/gemini-nano');
            ...
            function predict(inputText) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const output = yield model.generate(inputIds, {
                        max_new_tokens: 50,
                        do_sample: true,
                        temperature: 0.7,
                    });
            ...
            const app = new gradio_1.ChatInterface(predict, {
